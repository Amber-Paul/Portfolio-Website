...
export default function ContactCTASection({ onContactClick }: ContactCTASectionProps) {
  ...
  return (
    ...
    >
      ...
      <div className="max-w-3xl mx-auto text-center">
        <p className="text-sm font-mono text-violet-400 tracking-widest uppercase mb-6">
          Let&apos;s Build
        </p>

        <AnimatedText
          text="Ready to build something great?"
          className="justify-center text-4xl sm:text-5xl font-black text-zinc-100 mb-6 leading-tight"
          stagger={0.1}
        />
        ...
        >
          <motion.button
            ...
            className="px-10 py-4 rounded-full bg-violet-600 hover:bg-violet-500 text-white font-bold text-base transition shadow-lg shadow-violet-600/25"
          >
            Get in Touch
          </motion.button>
          ...
          <div className="flex items-center gap-4">
            <a
              ...
              className="p-2.5 rounded-full border border-zinc-700 text-zinc-400 hover:text-zinc-100 hover:border-zinc-500 transition"
            >
